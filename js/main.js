(function (html) {
  ...
  const ssLightbox = function () {
    ...
    function initCarousel(container) {
      const track = container.querySelector(".modal-carousel__track");
      const prevBtn = container.querySelector(".modal-carousel__prev");
      const nextBtn = container.querySelector(".modal-carousel__next");
      const dotsContainer = container.querySelector(".modal-carousel__dots");
      if (!track) return;
